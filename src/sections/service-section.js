    ...
    <section sx={{ variant: 'section.services' }}>
      ...
      {videoOpen ? (
        <div
          ...
          sx={styles.video_display_wrapper}
        >
          <div
            className="video_display"
            sx={styles.video_display_wrapper.video_display}
          >
            <iframe src="https://www.youtube.com/embed/ahy5o5nT4oI"></iframe>
            <span onClick={() => setVideoOpen(false)}>X</span>
          </div>
        </div>
      ) : (
        ''
